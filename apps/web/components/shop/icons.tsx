// Значки витрины: простые линейные SVG (свои, без сторонней библиотеки и лицензий). Цвет — от текста (currentColor).
// Новый значок: добавьте путь в PATHS; для задач на главной — ещё запись в TASK_ICONS (packages/core, storefront-menu.ts).
